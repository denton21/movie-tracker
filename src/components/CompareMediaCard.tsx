...
export default function CompareMediaCard({
    ...
    return (
        <>
            <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-purple-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/10">
                {/* Постер - клик открывает страницу медиа */}
                <Link href={`/media/${media.media_type}-${media.tmdb_id}`}>
                ...
                <div className="p-3 border-t border-white/10 grid grid-cols-2 gap-2">
                    ...
                    <button
                        ...
                        className="text-center p-2 rounded-lg hover:bg-white/5 transition-colors group/btn"
                    >
                        <p className="text-white/40 text-xs mb-1">Вы</p>
                        <UserStatusBadge userMedia={userMedia} />
                        <p className="text-purple-400 text-xs mt-1 opacity-0 group-hover/btn:opacity-100 transition-opacity">
                            ✏️ Изменить
                        </p>
                    </button>
                    ...
                    <div className="text-center p-2">
                        <p className="text-white/40 text-xs mb-1">Друг</p>
